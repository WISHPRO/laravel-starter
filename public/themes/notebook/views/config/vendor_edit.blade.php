...
<section class="panel panel-default">
  <div class="table-responsive">
    <table class="table table-striped">
        ...
        <tbody>
          <tr>
            {{ Form::open(array('route' => array('config.vendor.put', $id), 'method' => 'put')) }}
            <td>
  ...
  <div class="table-responsive">
    ...
    <table id="datatable" class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td @if($id == $vendor->id) style="background-color:#FFFFCC"@endif>{{ $vendor->id }}</td>
            <td @if($id == $vendor->id) style="background-color:#FFFFCC"@endif>{{ $vendor->name }}</td>
            <td @if($id == $vendor->id) style="background-color:#FFFFCC"@endif>{{ $vendor->contact }}</td>
            ...
            <td @if($id == $vendor->id) style="background-color:#FFFFCC"@endif class="text-center">
