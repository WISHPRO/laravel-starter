		...
		<table class="table table-striped">
	      ...
	      <tbody>
	        ...
	        <tr>
	          ...
	          $user_groups = $sentry_user->getGroups();
	          ...
	          <td class="text-center">
                ...
                {{ HTML::decode(HTML::link(route('user.delete', $user->id), '<i class="fa fa-times fa-fw"></i>', array('class' => 'btn btn-xs btn-default btn-user-edit', 'data-method' => 'delete', 'data-confirm' => 'Are you sure want to delete this user?'))) }}
	          </td>
	        </tr>
	        @endforeach
	      </tbody>
