...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      ...
      <a href="{{ route('survey.'.strtolower($vendor_type->type), $project->id) }}" class="btn btn-primary"
      @if($profile_incomplete) disabled="disabled" @endif>{{ $vendor_type->type }} Performance Evaluation Survey</a>
    </div>
  </div>